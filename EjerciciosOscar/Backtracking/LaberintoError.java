package EjerciciosOscar.Backtracking;

public class LaberintoError {
    ...
    public static void main(String[] args) {
        LaberintoError m = new LaberintoError(); 												// construimos un objeto de la clase Laberinto por defecto
