package EjerciciosOscar.Recursividad.practica;
...
public class E1_EjercicioPractica {
	...
	public static void main(String[] args) {
		int numero = 12345;
		int resultado = 0;
		resultado = contarDigitos3(numero);
		System.out.println("Numero de digitos: " + resultado);
...
//		System.out.println("Consonantes: "+ contarConsonantes(palabra, indice));
	...
	private static int contarDigitos2(int numero) {
		int contador = 0;
	...
	private static int contarDigitos3(int numero) {
		int valorRetorno = 0;
		if(numero < 10){
			return 1;
		}else{
			valorRetorno = contarDigitos3(numero/10);
